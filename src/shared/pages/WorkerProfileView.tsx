          ...
          {!loading && profile && (
            <>
              <div className="grid grid-cols-1 xl:grid-cols-[1.4fr_0.8fr] gap-4">
                <section className="border border-[#E85D04]/40 bg-[#1a1a1a] p-4 sm:p-5 shadow-[0_0_18px_rgba(232,93,4,0.08)] min-w-0">
                  <div className="flex flex-col md:flex-row gap-5">
                    <div className="shrink-0 flex flex-col items-center gap-3">
                      <div className="relative w-32 h-32 sm:w-36 sm:h-36 border-2 border-[#E85D04] bg-[#111111] overflow-hidden flex items-center justify-center shadow-[0_0_16px_rgba(232,93,4,0.22)]">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="border-b border-[#3a3a3a] pb-3 mb-4">
                        ...
                        <p className="text-[12px] text-[#C0C0C0] font-mono mt-1 break-words">
                          DNI:{" "}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                        <div className="border border-[#3a3a3a] bg-[#111111] p-3 hover:border-[#E85D04]/50 transition-colors min-w-0">
                        ...
                        <div className="border border-[#3a3a3a] bg-[#111111] p-3 hover:border-[#F59E0B]/50 transition-colors min-w-0">
                          <span className="block text-[10px] text-[#6B7280] font-mono uppercase tracking-label mb-1">
                            State
                          </span>
                      ...
                      <div className="border border-[#3a3a3a] bg-[#111111] p-4 hover:border-[#E85D04]/50 transition-colors min-w-0">
                        <span className="block text-[10px] text-[#6B7280] font-mono uppercase tracking-label mb-2">
                          Background description
                        </span>
                        <p className="text-[13px] text-[#C0C0C0] font-mono leading-relaxed break-words">
                ...
                <section className="border border-[#E85D04]/40 bg-[#1a1a1a] p-4 sm:p-5 shadow-[0_0_18px_rgba(232,93,4,0.08)] min-w-0">
                  <div className="flex items-center gap-2 border-b border-[#3a3a3a] pb-3 mb-4">
                    ...
                    <h2 className="text-[13px] font-mono text-white font-bold uppercase tracking-label break-words">
                      Health conditions
                    </h2>
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                <section className="border border-[#E85D04]/40 bg-[#1a1a1a] p-4 sm:p-5 shadow-[0_0_18px_rgba(232,93,4,0.08)] min-w-0">
                  ...
                  <div className="space-y-3 font-mono text-xs">
                    <div className="flex justify-between gap-4 border-b border-[#3a3a3a] pb-2">
                      <span className="text-[#6B7280] uppercase shrink-0">
                        Code
                      </span>
                    ...
                    <div>
                      ...
                      <p className="text-[#C0C0C0] leading-relaxed break-words">
                ...
                <section className="border border-[#E85D04]/40 bg-[#1a1a1a] p-4 sm:p-5 shadow-[0_0_18px_rgba(232,93,4,0.08)] min-w-0">
                  <div className="flex items-start sm:items-center justify-between gap-3 border-b border-[#3a3a3a] pb-3 mb-4">
                    ...
                    <span className="border border-[#E85D04] text-[#E85D04] bg-[#E85D04]/10 px-2 py-1 text-[9px] font-mono font-bold uppercase tracking-label shadow-[0_0_10px_rgba(232,93,4,0.18)] shrink-0">
                      Base
                    </span>
                  </div>
                  ...
                  {baseProfession ? (
                    <div className="space-y-3 font-mono text-xs">
                      ...
                      <div className="flex justify-between gap-4">
                        ...
                        <span className="text-[#C0C0C0] text-right flex items-center justify-end gap-1 break-words">
                ...
                <section className="border border-[#38BDF8]/40 bg-[#1a1a1a] p-4 sm:p-5 shadow-[0_0_18px_rgba(56,189,248,0.08)] min-w-0">
                  <div className="flex items-start sm:items-center justify-between gap-3 border-b border-[#3a3a3a] pb-3 mb-4">
                    <div className="flex items-center gap-2 min-w-0">
                    ...
                    {temporaryProfession ? (
                      <span className="border border-[#38BDF8] text-[#38BDF8] bg-[#38BDF8]/10 px-2 py-1 text-[9px] font-mono font-bold uppercase tracking-label shadow-[0_0_10px_rgba(56,189,248,0.2)] shrink-0">
                        Active
                      </span>
                    ) : (
                      <span className="border border-[#3a3a3a] text-[#6B7280] bg-[#2e2e2e] px-2 py-1 text-[9px] font-mono font-bold uppercase tracking-label shrink-0">
                        None
                      </span>
                    )}
                  </div>
                  ...
                  {temporaryProfession ? (
                    <div className="space-y-3 font-mono text-xs">
                      ...
                      <div className="flex justify-between gap-4 border-b border-[#3a3a3a] pb-2">
                        ...
                        <span className="text-[#C0C0C0] text-right break-words">
