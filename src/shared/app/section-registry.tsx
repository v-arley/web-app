...
const SECTION_CONFIGS: SectionConfig[] = [
    ...
    { key: "worker-profile",       path: "/app/worker/profile",       label: "Mi Perfil",        iconName: "UserRound",       componentName: "WorkerProfileView" },
    { key: "worker-achievements",  path: "/app/worker/achievements",  label: "Logros y puntos",  iconName: "Trophy",          componentName: "WorkerAchievementsView" },
    { key: "worker-tasks",         path: "/app/worker/tasks",         label: "Mis tareas",       iconName: "ClipboardCheck",  componentName: "WorkerTasksView" },
    { key: "worker-production",    path: "/app/worker/production",    label: "Producción diaria",iconName: "Database",        componentName: "WorkerProductionView" },
    { key: "worker-rations",       path: "/app/worker/rations",       label: "Raciones",         iconName: "ShoppingBag",     componentName: "WorkerRationsView" },
    { key: "worker-explorations",  path: "/app/worker/explorations",  label: "Exploraciones",    iconName: "Compass",         componentName: "WorkerExplorationsView" },
