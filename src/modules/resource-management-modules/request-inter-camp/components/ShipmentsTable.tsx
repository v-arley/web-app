  ...
  return (
    <div className="bg-bg-tertiary border border-border-default overflow-hidden">
      <div className="bg-bg-primary border-b border-border-default px-4 py-3 grid grid-cols-[0.6fr_0.7fr_0.8fr_0.9fr_0.9fr_1.2fr] gap-4">
        ...
        <div className="font-mono text-[9px] font-bold text-txt-secondary uppercase tracking-widest">SOLICITUD</div>
        <div className="font-mono text-[9px] font-bold text-txt-secondary uppercase tracking-widest text-center">ESTADO</div>
        <div className="font-mono text-[9px] font-bold text-txt-secondary uppercase tracking-widest">SALIDA</div>
        <div className="font-mono text-[9px] font-bold text-txt-secondary uppercase tracking-widest">LLEGADA</div>
