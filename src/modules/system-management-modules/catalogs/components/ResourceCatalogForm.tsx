    ...
    return (
        ...
        >
            <header className="px-6 py-4 border-b border-border-default bg-bg-secondary/20 backdrop-blur-lg">
                <div>
                    <h2 className="rmm-section-title font-abril">Resource Detail</h2>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <label className="flex flex-col gap-2">
                        <span className="rmm-label">Unit *</span>
                        <input className="rmm-input w-full" value={values.unitOfMeasure} onChange={(event) => setValues({ ...values, unitOfMeasure: event.target.value })} />
                    </label>
                    <label className="flex flex-col gap-2">
                        <span className="rmm-label">State</span>
                        <select className="rmm-input w-full" value={values.state} onChange={(event) => setValues({ ...values, state: event.target.value as "A" | "I" })}>
                    ...
                    <label className="flex items-center gap-3 border border-border-default bg-bg-secondary/20 p-3">
                        ...
                        />
                        <span className="rmm-label">Consumable Resource</span>
                    </label>
                </div>
